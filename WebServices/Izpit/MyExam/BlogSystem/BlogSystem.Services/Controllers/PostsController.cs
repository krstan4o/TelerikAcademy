...
namespace BlogSystem.Services.Controllers
{
    public class PostsController : BaseApiController
    {
        ...
        public HttpResponseMessage GetPostsTags(
           [ValueProvider(typeof(HeaderValueProviderFactory<string>))] string sessionKey, 
            string tags)
        {
            var responseMsg = this.PerformOperationAndHandleExceptions(
                () =>
                {
                    ...
                    using (context)
                    {
                        ...
                        var posts = GetAll(sessionKey).Where(p => tagsArr.All(t => p.Tags.Contains(t.ToLower())));
        ...
        public HttpResponseMessage GetPostKeyword([ValueProvider(typeof(HeaderValueProviderFactory<string>))]string sessionKey, string keyword, int count)
        {
            var responseMsg = this.PerformOperationAndHandleExceptions(
                () =>
                {
