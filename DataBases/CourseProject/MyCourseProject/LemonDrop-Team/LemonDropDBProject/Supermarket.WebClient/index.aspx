...
<body>
    <form id="form1" runat="server">
        ...
        <div class="containers">            
            ...
            <asp:Button ID="btnOpenPDF" runat="server"  Text="OpenPDF" OnClick="btnOpenPDF_Click"></asp:Button>
        </div>        
        <div class="containers">            
            ...
            <asp:Button ID="btnOpenXML" runat="server"  Text="OpenXML" OnClick="btnOpenXML_Click"></asp:Button>
        </div>                
        <div class="containers">            
