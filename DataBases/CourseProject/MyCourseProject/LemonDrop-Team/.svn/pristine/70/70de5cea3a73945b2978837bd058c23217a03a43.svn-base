...
{
    public class Task6VendorsTotalReport
    {
        public static void GenerateExcelVendorsTotalReport(string savePath)
        {
            ...
            CreateExcelTotalReport(vendors, savePath);
        }

        private static void CreateExcelTotalReport(List<VendorReport> productRaports, string savePath)
        {
           ...
           "Data Source=" + savePath + @"; Extended Properties=""Excel 12.0 Xml;HDR=YES""";
