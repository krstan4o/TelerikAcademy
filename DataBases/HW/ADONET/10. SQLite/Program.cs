...
class Program
{
    static void Main()
    {
        SQLiteConnection connection = new SQLiteConnection(@"Data Source=D:\Telerik\DataBases\HW\ADONET\10. SQLite\Library.db;Version=3;");
        AddBook(223, "JS UI", "Doncho", 2013, "911-22-11", connection);
